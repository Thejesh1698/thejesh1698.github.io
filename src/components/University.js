...
import { errorEmojis, universities, universityJavaCode } from "../assets/jsons/constants"
      ...
      <div className="university-java-main full-box">
        <div className={"university-left-wing full-height " + (!showFooter ? "active" : "")}>
          {isLoading ? <RocketLoader
            message={"calling getUniversityDetails() api!"} /> : <>{Object.keys(universities).map((key, value) => {
            return <div className="university-card"
              ...
              <div className="university-card-thumbnail full-width">
                {universities[key].thumbnail_urls.length ?
                  ...
                  <div className="thumbnail-fallback full-box">
                    <div className="fallback-emoji full-box"
                         dangerouslySetInnerHTML={{ __html: errorEmojis[activeUniversity === 1 ? 8 : 2] }} />
                    <div className="fallback-text full-box">
                      {activeUniversity === 1 ?
                        "Damn! These images are very hard to find!" :
                        "Grhh! It just escaped. Will find this image asap!"
                      }
                    </div>
                  </div>
                }
